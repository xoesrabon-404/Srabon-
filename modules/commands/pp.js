...
const fs = global.nodemodule["fs-extra"];
 ...
 let name = await Users.getNameUser(event.messageReply.senderID) 
	...
	var callback = () => api.sendMessage({body:`༺ᰔ⏤͟͟͞͞𝐽⃠𝑖𝐻𝐴𝐷 ⏤͟͟͞͞𝐻⃝𝐴𝑆𝐴𝑁ツ༻`, attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID,
 ...
 var callback = () => api.sendMessage({body:`༺ᰔ⏤͟͟͞͞𝐽⃠𝑖𝐻𝐴𝐷 ⏤͟͟͞͞𝐶𝐻𝐴𝑇 ⏤͟͟͞͞𝐵𝑂𝑇ツ༻`, attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID,
 () => fs.unlinkSync(__dirname + "/cache/1.png"),event.messageID); 
